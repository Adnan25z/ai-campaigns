...
const basePromptPrefix = "Define context of my organization:' My location is ";
...
const generateAction = async (req, res) => {
  ...
  const baseCompletion = await openai.createCompletion({
    ...
    prompt: `${basePromptPrefix}${req.body.location}${basePromptMiddle}${req.body.name}${basePromptMiddleOne}${req.body.revenue}${basePromptMiddleTwo}${req.body.purpose}${basePromptMiddleThree}${req.body.activities}${basePromptLast}`,
    temperature: 0.8,
    max_tokens: 250,
  });
